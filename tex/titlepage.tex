\begin{titlepage} % Suppresses displaying the page number on the title page and the subsequent page counts as page 1
    ...
    \textsc{\Large Algorithms and Data Structures}\\[0.5cm] % Major heading such as course name

    \textsc{\large COSC 3320}\\[0.5cm] % Minor heading such as course title
    ...
    \begin{minipage}{0.4\textwidth}
        \begin{flushright}
            ...
            Dr. Gopal \textsc{Pandurangan} % Supervisor's name
        \end{flushright}
    \end{minipage}
